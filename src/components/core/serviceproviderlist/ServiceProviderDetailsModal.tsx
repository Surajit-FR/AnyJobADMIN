...
const ServiceProviderDetailsModal = (): JSX.Element => {
    ...
    return (
        <>
            <div className="modal fade" id="serviceproviderdetailsmodal" tabIndex={-1} role="dialog" aria-hidden="true">
                <div className="modal-dialog modal-lg">
                    <div className="modal-content p-3">
                        <div className="modal-header">
                            <h4 className="modal-title" id="myServiceproviderdetailsmodalLabel">Service Provider Details</h4>
